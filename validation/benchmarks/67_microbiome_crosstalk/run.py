...
def run() -> dict:
    ...
    try:
        ...
        return {
            ...
            "details": details,
            "reference": {
                "source": "Gut microbiome xenobiotic metabolism and organ crosstalk",
                "authors": "Spanogiannopoulos P, Turnbaugh PJ et al.",
                "year": 2016,
                "journal": "Nat Rev Microbiol",
                "doi": "10.1038/nrmicro.2016.17",
                "note": "Spanogiannopoulos P et al. 2016, Nat Rev Microbiol 14:273-287. Gut microbial drug metabolism.",
                "microbiome": "Spanogiannopoulos P et al. 2016, Nat Rev Microbiol 14:273",
