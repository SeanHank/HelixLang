...
Generated: 2026-09-02 12:41:08 UTC
...
| Failures | 0 |
| Skipped | 1 |
| Validation levels | L0×46 · L1×2 · L2×7 · L3×16 · L4×14 · L5×0 |
...
| 11_performance_comparison | FBA solve-time performance vs COBRApy | metabolism | L1 | 8 metrics → ecoli_core.n_reactions=95, ecoli_core.cobrapy_100_solves_s=0.0318, ecoli_core.helixlang_100_solves_s=2.5026 → ecoli_core.n_reactions=95, ecoli_core.cobrapy_100_solves_s=0.0318, ecoli_core.helixlang_100_solves_s=2.5026 → verified | ✅ PASS |
...
| 56_blast_search | BLAST search wrapper | annotation | L0 | 4 automated checks → import_blast_module=True, hit_dataclass=True, search_result_hits_for=True → passed=3, total=4 → FAILED | ⏭ SKIP |
