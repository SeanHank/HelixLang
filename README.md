...
| [`39-performance-optimization-survey.md`](doc/39-performance-optimization-survey.md) | Realism-preserving cross-stack performance optimization plan |
| [`40-human-immune-realism.md`](doc/40-human-immune-realism.md) | Literature-grounded human immune simulation realism upgrade plan |
| [`41-ci-validation-levels-extensible-parser.md`](doc/41-ci-validation-levels-extensible-parser.md) | CI repair, validation-level taxonomy, extensible parser, physical types, model provenance |
...
- [71/75 validation benchmarks](validation/report.md) with SHA256 goldens
