...
| VD-2 | **P0** | **"100% real" over-claim vs `DISCLAIMER.md`** — README + `plugins/human/__init__.py:34` claim every parameter anchored to literature, while the disclaimer says outputs "not faithful reproductions" | `README.md:159`, `plugins/human/__init__.py:34`, `DISCLAIMER.md` | HIGH (doc risk) |
