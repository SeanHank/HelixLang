...
# Static assets directory: src/helixlang/web/
_WEB_DIR = Path(__file__).parent / "web"
# examples/ directory: src/helixlang/server.py → src/helixlang → src → HelixLang/
...
def create_app() -> Flask:
    ...
    @app.get("/api/health")
    def health():
        return jsonify({"status": "ok", "version": "2026.8.0"})
    ...
    def api_dna_encode():
        ...
        from helixlang.dna_codec import gc_stats, helix_to_dna, pcr_amplify
    ...
    def api_dna_decode():
        ...
        if scheme not in ("goldman", "erlich"):
            return jsonify({"error": f"unknown scheme {scheme!r}"}), 400
        from helixlang.dna_codec import dna_to_helix
    ...
    def api_codon_usage():
        ...
        from helixlang.bio_data import SPECIES_CODON_USAGE, get_codon_usage
    ...
    def api_trna():
        ...
        from helixlang.bio_data import SPECIES_TRNA_ABUNDANCE, get_species_trna
        species = (request.args.get("species") or "ecoli").strip().lower()
        try:
    ...
    def api_gs_presets():
        ...
        from helixlang.bio_data import GRAY_SCOTT_PRESETS
        return jsonify({
            "presets": [
    ...
    def api_transcribe():
        ...
        from helixlang.central_dogma import transcribe
    ...
    def api_evolution_params():
        ...
        from helixlang.evolution import EvolutionConfig
        cfg = EvolutionConfig()
        defaults = {
    ...
    def api_crispr_find_pam():
        ...
        from helixlang.crispr import find_pam_sites
    ...
    def api_crispr_design_guide():
        ...
        from helixlang.crispr import design_guide, on_target_score
    ...
    def api_cpg_islands():
        ...
        body = request.get_json(force=True, silent=True) or {}
        dna = body.get("dna", "")
        from helixlang.epigenetics import find_cpg_islands
    ...
    def api_dna_storage_store():
        ...
        from helixlang.dna_codec import gc_stats
    ...
    def api_dna_storage_analyze():
        ...
        scheme = (body.get("scheme", "erlich") or "erlich").lower()
        from helixlang.apps.dna_storage import DNAStorage
        from helixlang.dna_codec import ErlichOligo, GoldmanOligo
    ...
    def api_protein_secondary():
        ...
        from helixlang.protein_structure import predict_secondary, predict_secondary_gor
        if method == "gor":
    ...
    def api_protein_transmembrane():
        ...
        body = request.get_json(force=True, silent=True) or {}
        sequence = body.get("sequence", "")
        from helixlang.protein_structure import gravy, hydropathy_profile, predict_transmembrane
    ...
    def api_protein_disorder():
        ...
        body = request.get_json(force=True, silent=True) or {}
        sequence = body.get("sequence", "")
        from helixlang.protein_structure import predict_disorder
