...
Folds a :class:`~helixlang.plugins.human.genotype.GenotypeProfile` and observable
:class:`ExternalTraits` (age, sex, anthropometrics, smoking, pregnancy,
exercise, ethnicity) into a fully scaled
:class:`~helixlang.plugins.human.physiology.HumanPhysiology` and the final hepatic
