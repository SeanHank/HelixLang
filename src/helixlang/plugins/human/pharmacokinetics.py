...
Couples :class:`~helixlang.plugins.human.drug.Drug` regimen specifications with
:class:`~helixlang.plugins.human.physiology.HumanPhysiology` perfusion data to
...
:mod:`helixlang.plugins.human.drug`. Summary endpoints in :class:`PBPKResult` —
...
class PBPKConfig:
    ...
    adult of :mod:`helixlang.plugins.human.physiology`.
    """
