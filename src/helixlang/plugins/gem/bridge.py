...
if TYPE_CHECKING:
    from helixlang.plugins.gem.consensus import ConsensusResult
    from helixlang.plugins.gem.grn_inference import RegulatoryEdge
...
def build_enzyme_capacity(
    ...
    """
    from helixlang.plugins.runtime.metabolism import EnzymeCapacity
