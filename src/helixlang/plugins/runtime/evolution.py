...
from helixlang.plugins.runtime.protein_fitness import FitnessOracle
...
def calculate_fitness(dna: str,
    ...
    method:
        ...
        "oracle":  ML-guided protein fitness oracle (T2.4, P8): the
                   ...
                   target_dna by a :class:`helixlang.plugins.runtime.protein_fitness.
    ...
    if method == "oracle":
        ...
        from helixlang.plugins.runtime.protein_fitness import dna_fitness
    ...
    if method == "hamming":
        ...
        # ECOLI_CODON_USAGE)
        from helixlang.plugins.runtime.biocodec import codon_adaptation_index_full
...
class EvolutionaryPopulation:
    ...
    (also originally called ``Population``) in ``helixlang.plugins.runtime.population``,
...
# to distinguish it from ``helixlang.plugins.runtime.population.CellPopulation``. This
