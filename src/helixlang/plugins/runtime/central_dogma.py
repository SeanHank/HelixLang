...
from helixlang.plugins.runtime.bio_data import ECOLI_CODON_USAGE, MAX_TRNA_ABUNDANCE, TRNA_ABUNDANCE
...
# helixlang.plugins.runtime.bio_data, and central_dogma references them via the import at
