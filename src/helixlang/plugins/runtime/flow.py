...
tick = 1 min; see :mod:`helixlang.core.units`).  It drives:
...
from helixlang.core.units import DIFFUSION_DT_S, LATTICE_SPACING_UM
...
class FlowField3D:
    ...
    (:meth:`~helixlang.plugins.runtime.environment.ConcentrationField3D.advect_3d`) and
    3D cell drift.
    """
