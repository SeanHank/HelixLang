...
Biological grounding (physical units from :mod:`helixlang.core.units`; one
...
- Diffusion follows Fick's law with a physical coefficient in µm^2/s,
  ...
  :func:`helixlang.core.units.diffusion_to_lattice` (same sub-stepped
  explicit 5-point Laplacian as the AI-2 field in
  :mod:`helixlang.plugins.runtime.population`).
...
(Alberts, *Molecular Biology of the Cell*; :data:`helixlang.core.units.
