...
from helixlang.plugins.runtime.grn import GRN, _activation_raw
...
class SparseGRN:
    ...
    def from_grn(cls, grn: GRN, noise_seed: int | None = None
        ...
        """Build a sparse GRN from a scalar :class:`~helixlang.plugins.runtime.grn.GRN`.
    ...
    def to_grn(self) -> GRN:
        """Materialize a scalar :class:`~helixlang.plugins.runtime.grn.GRN` template.
