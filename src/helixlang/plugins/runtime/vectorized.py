...
- :class:`VectorizedGRN`: the :class:`~helixlang.plugins.runtime.grn.GRN` discrete
...
:mod:`helixlang.plugins.runtime.environment` / :mod:`helixlang.plugins.runtime.population`); parallel
        ...
        for row in inputs:
            ...
            for g, x in enumerate(row):
                if self._hill_n[g] and self._hill_n[g] > 0:
                    ...
                    from helixlang.plugins.runtime.grn import sigmoid
