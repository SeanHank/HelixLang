...
- the macroscopic velocity is fed back to the environment as a
  :class:`~helixlang.plugins.runtime.flow.FlowField` driving substrate advection and
  cell drift,
...
class LatticeBoltzmann:
    ...
    def flow_field(self, substeps: int = 1) -> FlowField:
        """The solver velocity field as a :class:`~helixlang.plugins.runtime.flow.FlowField`.
