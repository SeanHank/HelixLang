...
from helixlang.plugins.runtime.metabolism import simplex
...
class CommunityFBA:
    ...
    with the pure-Python simplex (:func:`helixlang.plugins.runtime.metabolism.simplex`),
...
class Patch:
    ...
    def _growth_rate_gem(
        ...
        try:
            ...
            from helixlang.plugins.runtime.metabolism import enzyme_correction
