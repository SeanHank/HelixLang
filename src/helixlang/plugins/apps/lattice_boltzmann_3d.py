...
The 3D counterpart of :mod:`helixlang.plugins.apps.lattice_boltzmann` (D2Q9).
...
- the macroscopic velocity field is fed back to the population as a
  :class:`~helixlang.plugins.runtime.flow.FlowField3D` driving 3D substrate advection
  and cell drift,
...
class LatticeBoltzmann3D:
    ...
    def flow_field(self, substeps: int = 1) -> FlowField3D:
        """The solver velocity field as a :class:`~helixlang.plugins.runtime.flow.FlowField3D`.
