...
2. The sparse core is :class:`~helixlang.plugins.runtime.sparse_grn.SparseGRN` (CSR
...
3. :class:`GenomeColony` runs a whole population of genome-scale cells in
   ...
   (:data:`~helixlang.plugins.runtime.metabolism.ECOLI_CORE_GENE_REACTIONS`).
...
def _gated_biomass(off_reactions: tuple[str, ...],
    ...
    from helixlang.plugins.apps.whole_cell_scale import ko_model
