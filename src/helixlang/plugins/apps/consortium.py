...
:mod:`helixlang.plugins.runtime.population`: autoinducer emission (µM/tick, Xavier &
...
(:func:`helixlang.core.units.diffusion_to_lattice`), an energy budget with
...
real :class:`~helixlang.plugins.runtime.population.CellPopulation` VM pipeline.
"""
