...
- **SBML import** (Hucka et al. 2003, sbml.org): parses a minimal
  ...
  :class:`helixlang.plugins.runtime.metabolism.MetabolicModel` so models from
...
Stdlib-only (``xml.etree``); see :mod:`helixlang.plugins.apps.synbio_automation`
...
from helixlang.core.sbol import (  # noqa: F401  (single source, re-exported)
    RDF_NS,
    SBML_NS,
    SBOL_ENCODING_IUPAC,
    SBOL_NS,
