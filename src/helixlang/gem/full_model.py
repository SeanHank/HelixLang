...
class FullModelAdapter:
    ...
    def __init__(
        ...
        from helixlang.gem.organism_registry import get_organism_config
    ...
    def from_bigg(cls, organism_id: str) -> FullModelAdapter:
        ...
        from helixlang.gem.organism_registry import get_organism_config
        from helixlang.gem.sbml_import import load_bigg_model
...
def list_supported_organisms_str() -> str:
    ...
    from helixlang.gem.organism_registry import list_supported_organisms
