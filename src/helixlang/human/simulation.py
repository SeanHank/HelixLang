...
:func:`~helixlang.human.disease.apply_disease_state`; the sibling
...
from helixlang.human.disease import apply_disease_state
...
try:
    from helixlang.human.pharmacokinetics import PBPKConfig
except ImportError:
...
class HumanSimulation:
    ...
    through :attr:`~helixlang.metabolism.DynamicFluxBalance.
    ...
    def _load_base_model(self) -> Any:
        ...
        if path:
            try:
                ...
                return model
            except (OSError, ValueError, KeyError, BioError):
                pass
