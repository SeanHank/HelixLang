...
:class:`~helixlang.metabolism.MetabolicModel`, applies every perturbation,
...
:class:`~helixlang.metabolism.MetabolitePool`.
...
from helixlang.metabolism import ECOLI_CORE_GENE_REACTIONS, MetabolicModel
...
#: for seeding a :class:`~helixlang.metabolism.MetabolitePool`
...
def _resolve_affected_reactions(model: MetabolicModel,
    ...
    4. the curated :data:`~helixlang.metabolism.ECOLI_CORE_GENE_REACTIONS`
...
def apply_disease_state(model: MetabolicModel,
    ...
    Args:
        model: a :class:`~helixlang.metabolism.MetabolicModel`
            (e.g. a human GEM loaded through ``helixlang.human.gem_human``).
        disease: the :class:`DiseaseState` to express.

    Returns:
        a new, diseased :class:`~helixlang.metabolism.MetabolicModel`.
    """
