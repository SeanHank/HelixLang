...
EXPECTED_DRUGS = {
    ...
    "WARFARIN", "CLOPIDOGREL", "ATORVASTATIN", "AMLODIPINE",
    "LOSARTAN", "PANTOPRAZOLE", "SERTRALINE", "FLUOXETINE",
    "CITALOPRAM", "TRAMADOL", "ALLOPURINOL", "PREDNISONE",
    "OMEPRAZOLE", "SIMVASTATIN", "DIPHENHYDRAMINE",
}
